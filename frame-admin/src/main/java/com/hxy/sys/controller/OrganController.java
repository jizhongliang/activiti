...
public class OrganController extends BaseController{
	...
	public Result orgList(@RequestBody OrganEntity organEntity){
		//查询列表数据
		List<OrganEntity> organEntityList=organService.orgList(organEntity);
		return Result.ok().put("data", organEntityList);
	}
}
